import { type DoughType, doughPresets, doughTypeList } from '@/util/dough-presets';
...
export function DoughTypeSelector({ selected, onSelect }: DoughTypeSelectorProps) {
  return (
      ...
      {doughTypeList.map((type) => {
        ...
        return (
          <button
            ...
            onClick={() => { if (!isSelected) onSelect(type); }}
